...
- 🎥 Accepts video input
- 🗣️ Converts speech to text automatically
- ✍️ NLP-based grammar restructuring for sign language
- 🧏 Outputs ASL gestures via animations or sign clips
...
🧠 Improved contextual understanding using transformers
---
🤝 Contribution
